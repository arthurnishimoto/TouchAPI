...
public class Yas_TouchEventManager {
	PApplet p;
	float radius;
	float lifetime = 100;
	...
	public Yas_TouchEventManager(PApplet o){
		p = o;
	...
	public Yas_TouchEventManager(PApplet o, TouchAPI t){
		p = o;
		radius = (float) (.08 * o.width);
		tacTile = t;
		tacTile.setTouchLifeTime(5);
	...
	public void process(){
          ...
          if( tacTile.hasTouchListener() ){
	          ...
	          ArrayList holdList = getAllTouches();
