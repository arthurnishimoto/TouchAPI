...
public class UDP implements Runnable {
	...
	public UDP( Object owner, int port, String ip ) {
		...
		// CHANGE HERE...
		//   We do not need to bind this instance to a PApplet
		//   So we comment it out.  This allows an instance to bind
		//   to a TouchAPI instance with out errors.  That way the 
		//   event driven polling will look in TouchAPI for the 
		//   required method.  
